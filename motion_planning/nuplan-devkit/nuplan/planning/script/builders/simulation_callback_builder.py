...
def build_simulation_callbacks(
    ...
    for config in cfg.callback.values():
        ...
        elif str(config._target_) == "nuplan.planning.simulation.callback.timing_callback.TimingCallback":
            # Import torch lazily because TensorBoard timing support is optional.
            import torch
